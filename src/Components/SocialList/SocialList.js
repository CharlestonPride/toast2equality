...
export default class SocialList extends Component {
    ...
    Social(props) {
        ...
        && <a className="social" target="_blank" href={props.url + props.page + "/?utm_source=charleston_pride&utm_medium=toast_to_equality&utm_campaign=sponsors"}><i className={"icofont icofont-" + props.icon} aria-hidden="true"></i></a>
    }
